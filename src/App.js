    ...
    /*fetch('http://localhost:8000/notes')
      ...
      setNotes({
        "notes": [
          ...
          {
            "title": "내가 내 집 뽑아서 만들 수 있는데 꼬움?",
            "details": "3D프린터 소유하기",
            "category": "소유",
            "success": "1",
            "date": "2022",
            "image": "",
            "successdetails": "엔더3 프로인가 뭔가 샀는데 둘 공간이 없어서 실외기실에 둠. 근데 여름에는 실외기 위에 있어서 못쓰고 겨울에는 안착 안돼서 못쓰고 가을에 쓰려고 봤더니 익스트루더 부러져있어서 부품 샀는데 조림하기 귀찮아서 안 뽑고 있는 중.",
            "successimage": "",
            "id": 117
          },
          /* sample
